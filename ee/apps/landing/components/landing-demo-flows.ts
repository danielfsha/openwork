...
export const landingDemoFlows: DemoFlow[] = [
  {
    ...
    task: "Open this Twitter thread, like all the replies, and extract the user details into a CSV file.",
    context:
  ...
  },
  {
    ...
    task: "Analyze this Excel model even if the user uploads the file or pastes the spreadsheet directly into chat.",
    context:
    ...
    chatHistory: [
      {
        role: "user",
        content:
          "Here is the Q3_Financials.xlsx file. Find the biggest outliers.",
      },
      {
        role: "timeline",
        items: [
  ...
  },
  {
    ...
    categoryLabel: "Follow-up + Scheduling",
    tabLabel: "Draft follow-up and reschedule",
    title: "Draft follow-up and reschedule",
    description:
      "Use analysis-ready context to draft personalized outreach and reschedule the next touchpoint in your calendar.",
    activeAgent: {
    ...
    task: "Draft founder outreach from our Notion workspace, then reschedule the next meeting and sync updates to HubSpot.",
    context:
      "Use the Notion MCP notes and recent deal context to align tone, timing, and the next best follow-up window.",
    output:
      "Create the email draft, update the CRM record, and reschedule the next touchpoint.",
    chatHistory: [
      {
        role: "user",
        content:
          "Draft a follow-up to Acme Corp based on our last meeting notes, then reschedule next week.",
      },
      {
        role: "timeline",
        items: [
          ...
          "Execution timeline 1 step - Reschedules next touchpoint in calendar",
        ],
      },
      {
        role: "agent",
        content:
          "I drafted the follow-up email based on your Notion notes and rescheduled the next touchpoint for Tuesday at 10:00 AM. Would you like me to sync this update to HubSpot?",
      },
    ],
  },
];
