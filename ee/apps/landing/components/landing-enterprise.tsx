...
export function LandingEnterprise(props: Props) {
  const [activeStackDemoId, setActiveStackDemoId] = useState(
    defaultLandingDemoFlowId,
  );
            ...
            <div className="grid gap-8 lg:grid-cols-[minmax(0,1.15fr)_minmax(0,0.85fr)] lg:items-start lg:gap-10">
              <div className="max-w-3xl">
                <h1 className="mb-5 text-4xl font-medium leading-[1.1] tracking-tight md:text-5xl lg:text-6xl">
                  A privacy-first alternative to Claude Cowork
                  <br />
              ...
              <p className="max-w-xl text-lg leading-relaxed text-slate-600 md:text-xl lg:pt-2">
